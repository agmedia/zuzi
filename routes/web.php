...
Route::middleware(['auth:sanctum', 'verified', 'no.customers'])->prefix('admin')->group(function () {
    ...
    Route::prefix('catalog')->group(function () {
        ...
        Route::get('delfi-import/settings/genre-mappings', [DelfiImportController::class, 'genreMappings'])->name('delfi-import.genre-mappings');
    ...
    Route::prefix('admin')->middleware(['auth'])->group(function () {
        ...
        Route::post('/wishlists/product/{product}/send', [WishlistController::class, 'sendProduct'])->name('wishlists.products.send');
        Route::post('/wishlists/item/{wishlist}/send', [WishlistController::class, 'sendWishlist'])->name('wishlists.items.send');
    });
...
Route::prefix('api/v2')->group(function () {
    ...
    Route::prefix('filter')->group(function () {
        ...
        Route::post('/getToolbarFilters', [FilterController::class, 'toolbarFilters']);
    ...
    Route::prefix('settings')->group(function () {
        ...
        Route::prefix('app')->group(function () {
            ...
            Route::prefix('order-status')->group(function () {
                ...
                Route::post('send/boxnow', [OrderController::class, 'api_send_boxnow'])->name('api.order.send.boxnow');
...
Route::get('/dojmovi', [HomeController::class, 'reviews'])->name('dojmovi');
...
//
Route::get('{group}/{cat?}/{subcat?}/{prod?}', [CatalogRouteController::class, 'resolve'])->middleware('affiliate.track')->name('catalog.route');
