...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('novella_import_feed_rows')) {
            Schema::create('novella_import_feed_rows', function (Blueprint $table) {
                ...
                $table->unique(['feed_token', 'external_id'], 'novella_feed_rows_token_external_unique');
                $table->index(
                    ['feed_token', 'remote_product_id'],
                    'novella_feed_rows_token_remote_index'
                );
                $table->index('created_at', 'novella_feed_rows_created_at_index');
            });
        }

        if (! Schema::hasTable('novella_import_products')) {
            Schema::create('novella_import_products', function (Blueprint $table) {
                $table->bigIncrements('id');
    ...
    {
        Schema::dropIfExists('novella_import_products');
        Schema::dropIfExists('novella_import_feed_rows');
    }
};
