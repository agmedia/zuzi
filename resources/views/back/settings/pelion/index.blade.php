        ...
        function renderPelionNameCandidates(body) {
            ...
            candidates.forEach((candidate, index) => {
                ...
                rows.push(
                    ...
                    '<td>' + (currentItem.ITEMID ? '<div class="font-w600">' + escapeHtml(currentItem.ITEMNAME || '-') + '</div><div class="text-muted">ITEMID: ' + emptyDash(currentItem.ITEMID) + '<br>Pelion qty: ' + emptyDash(currentItem.STOCKQUANTITY) + '<br>BARCODE: ' + emptyDash(currentItem.ITEMBARCODE) + '<br>CODE: ' + emptyDash(currentItem.ITEMCODE) + '</div>' : '<span class="text-muted">Nema lokalnog Pelion para</span>') + '</td>' +
                    '<td><div class="font-w600">' + escapeHtml(proposed.ITEMNAME || '-') + '</div><div class="text-muted">ITEMID: ' + emptyDash(proposed.ITEMID) + '<br>Pelion qty: ' + emptyDash(proposed.STOCKQUANTITY) + '<br>BARCODE: ' + emptyDash(proposed.ITEMBARCODE) + '<br>CODE: ' + emptyDash(proposed.ITEMCODE) + '</div></td>' +
