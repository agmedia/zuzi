    ...
    <section class="bg-accent bg-position-top-left bg-repeat-0 py-5" style="background-image: url('media/img/lightslider.webp');-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;">
        <div class="pb-lg-5 mb-lg-3">
            <div class="container py-lg-4 my-lg-5">
                    ...
                    <div class="col-lg-6 col-md-8">
                        <form action="{{ route('pretrazi', ['tip' => 'autor']) }}" method="get">
                            <div class="input-group input-group-lg flex-nowrap">
                                <input type="text" class="form-control rounded-start" name="{{ config('settings.search_keyword') }}" placeholder="Probaj me — sad sam još bolja 📚">
                ...
                <div class="widget mt-4 text-md-nowrap text-center text-md-start d-flex align-items-center flex-wrap justify-content-center justify-content-md-start">
                    <a class="btn-social bs-light bs-instagram me-2 mb-2" href="https://www.instagram.com/zuziobrt/"><i class="ci-instagram"></i></a>
                    <a class="btn-social bs-light bs-tiktok d-inline-flex align-items-center justify-content-center me-2 mb-2" href="https://www.tiktok.com/@zuziantikvarijat" target="_blank" rel="noopener" aria-label="TikTok">
