          ...
          <div class="d-flex row justify-content-between">
              ...
              <div class="col-md-12">
                  <div class="alert alert-info d-flex  mb-1 " role="alert">
                      ...
                      <small><strong>AKCIJA: 20% popusta</strong> na sve uz kod: <strong>INTERLIBER20</strong> -  Važno: <a href="https://www.zuzi.hr/info/uvjeti-dostave"><!--<strong>Rok isporuke </strong></a> za regionalne naslove je do 20 dana.--> Zbog velikog interesa isporuka može malo kasniti. Radimo brzo — vi samo uživajte. ❤️ </small>
