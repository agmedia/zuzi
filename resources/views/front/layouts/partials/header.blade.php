        ...
        <div class="container-fluid">
            ...
            <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center ms-xl-2">
                ...
                @php
                    ...
                    $isBackOfficeUser = $currentUser && $currentUser->isNotAn('customer');
                    $accountNotice = app(\App\Services\AccountNoticeService::class)->get();
                    $hasAccountNotice = ! $isBackOfficeUser && (bool) ($accountNotice['active'] ?? false);
                    $accountUrl = $isBackOfficeUser
                        ? route('dashboard')
                        : route('moj-racun');
                @endphp
...
<aside class="offcanvas offcanvas-expand w-100 border-end zindex-lg-5 pt-lg-5" id="sideNav" style="max-width: 18.875rem;">
    ...
    <div class="offcanvas-footer d-flex align-items-center flex-wrap px-grid-gutter pt-3 pb-2 mb-0" style="background-color: #f6f9fc;">
        ...
        <a class="btn-social bs-light bg-primary bs-tiktok d-inline-flex align-items-center justify-content-center me-2 mb-2" href="https://www.tiktok.com/@zuziantikvarijat" target="_blank" rel="noopener" aria-label="TikTok">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 448 512" aria-hidden="true" focusable="false"><path d="M448.5 209.9c-44 .1-87-13.6-122.8-39.2l0 178.7c0 33.1-10.1 65.4-29 92.6s-45.6 48-76.6 59.6-64.8 13.5-96.9 5.3-60.9-25.9-82.7-50.8-35.3-56-39-88.9 2.9-66.1 18.6-95.2 40-52.7 69.6-67.7 62.9-20.5 95.7-16l0 89.9c-15-4.7-31.1-4.6-46 .4s-27.9 14.6-37 27.3-14 28.1-13.9 43.9 5.2 31 14.5 43.7 22.4 22.1 37.4 26.9 31.1 4.8 46-.1 28-14.4 37.2-27.1 14.2-28.1 14.2-43.8l0-349.4 88 0c-.1 7.4 .6 14.9 1.9 22.2 3.1 16.3 9.4 31.9 18.7 45.7s21.3 25.6 35.2 34.6c19.9 13.1 43.2 20.1 67 20.1l0 87.4z"/></svg>
        </a>
