            ...
            <div class="d-lg-flex justify-content-center align-items-center ps-lg-4">
                <div class="position-relative mx-auto py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
                    <div class="pb-lg-5 mb-lg-5 pt-lg-5 mt-lg-5 text-center">
                        ...
                        <div class="scale-up delay-4 mx-auto mx-lg-0"><a class="btn btn-primary" href="{{ route('catalog.route', ['group' => \App\Helpers\Helper::categoryGroupPath(true) . '/antikvarne-knjige']) }}">Saznajte više<i class="ci-arrow-right ms-2 me-n1"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
